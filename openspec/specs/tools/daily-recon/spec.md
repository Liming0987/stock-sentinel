...
The daily recon skill generates a pre-market intelligence report for every stock in the watchlist — synthesising technicals, Wyckoff, VCP, DCF, fundamentals, relative strength, earnings proximity, sector momentum, financial statements, and a 0–100 conviction score into a per-stock HTML report with a plain-English buy/sell stance.

## Requirements

### Requirement: Analysis schema includes RS rating, earnings, sector momentum, and score breakdown
The daily recon skill analysis JSON SHALL include the following fields:
